const seriesData = {
    ...
    'dev-interrupted': {
        ...
        'description': ['The Dev Interrupted Podcast is the premier podcast made exclusively for software engineering leaders. Hosts Dan Lines &amp; Conor Bronsdon invite expert guests from around the world to explore strategy and day-to-day topics ranging from dev team metrics to accelerating delivery. Join us weekly for new episodes.'],
        'credits': {
            'host': 'Conor Bronsdon',
            'publisher': 'LinearB',
        },
    ...
    'switched-on-pop': {
        ...
        'description': ['A podcast all about the making and meaning of popular music. Musicologist Nate Sloan & songwriter Charlie Harding pull back the curtain on how pop hits work magic on our ears & our culture. From Vulture and the Vox Media Podcast Network.'],
        'credits': {
